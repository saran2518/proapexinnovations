...
function Index() {
  ...
  return (
    <div>
      {/* NAV */}
      <nav className="fixed inset-x-0 top-0 z-[200] flex h-[104px] items-center justify-between border-b border-line bg-white pl-4 pr-[5vw]">
      ...
      <section
        id="hero"
        className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-navy px-[5vw] pb-16 pt-[calc(104px+3rem)]"
      >
        <div
