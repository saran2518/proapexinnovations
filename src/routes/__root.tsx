...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ProApex is a consumer AI company that builds and owns category-defining brands in high-TAM markets." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "ProApex Innovations" },
      { property: "og:description", content: "ProApex is a consumer AI company that builds and owns category-defining brands in high-TAM markets." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "ProApex Innovations" },
      { name: "twitter:description", content: "ProApex is a consumer AI company that builds and owns category-defining brands in high-TAM markets." },
